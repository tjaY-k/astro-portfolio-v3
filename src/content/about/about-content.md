...
I handle the technical planning and delivery of video systems for live events and permanent installations: projection mapping, media server programming, LED screen design, and the site-wide networks that tie a venue together. In practice that means owning the whole chain — equipment specs, signal design, crew coordination — and sitting at the desk when the show goes live.

Nineteen years in — the first eleven in broadcast, live events since 2018 — the work has ranged from a 230-metre projection on One Za'abeel that took three Guinness World Records, to a single control system linking ten stages at MDLBEAST Soundstorm, to broadcast infrastructure at a FIFA World Cup stadium. Different scales, same discipline: plan for what can fail, and keep a way to fix it live.
